...
window.showToast = showToast;
    ...
    try {
        ...
        try {
            ...
            const weatherApiUrl = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&current=temperature_2m,relative_humidity_2m,weather_code,wind_speed_10m&daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset&timezone=auto&forecast_days=7`;
            ...
            const renderNewFinancialDashboard = () => {
                ...
                const overdueTransactions = allCombinedTransactions
                    .filter(t => {
                        ...
                        return (isExpense || isOverdueInstallment) && new Date(t.date + 'T00:00:00') < today;
                    })
                ...
                try {
                    ...
                    onAuthStateChanged(auth, async (user) => {
                        ...
                        if (user) {
                            ...
                            // (Removido) Botão de teste de push debug
